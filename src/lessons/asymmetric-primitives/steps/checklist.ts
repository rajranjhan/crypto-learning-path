...
export const checklist: Step = {
  id: "checklist",
  title: "Asymmetric Cryptography Checklist",
  prose:
  ...
  bullets: [
    ...
    "RSA encryption and RSA signatures are different jobs: OAEP for encryption, PSS for signatures — never textbook RSA",
  ...
  takeaway: "Signatures (RSA-PSS, ECDSA) prove origin without a shared secret; HMAC (previous lesson) proves origin with one — pick based on whether the verifier already shares a key with the sender.",
  callouts: [
    {
