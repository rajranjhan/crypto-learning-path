...
export const rsaPadding: Step = {
  ...
  prose:
    ...
    "<p>The practical rule: never call raw RSA encrypt/decrypt directly. If RSA encryption is required, use RSA-OAEP. For RSA signatures, use RSA-PSS. In modern secure-channel protocols, prefer ephemeral Diffie-Hellman for key agreement instead of RSA key transport; RSA's most common modern role is signing, not carrying bulk secrets.</p>",
  bullets: [
