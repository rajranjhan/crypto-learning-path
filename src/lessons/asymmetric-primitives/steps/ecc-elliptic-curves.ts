...
export const eccEllipticCurves: Step = {
  ...
  title: "Elliptic Curve Cryptography — Smaller Keys",
  prose:
  ...
  takeaway: "ECDSA: ECC's signature scheme — the elliptic-curve counterpart to RSA-PSS.",
  figure: {
    body: `
    <div class="flow">
      ...
      <div class="node node-proxy equal">
        ...
        <div class="node-sub">curve discrete log; small keys</div>
      </div>
    </div>
    <p class="diagram-note">
      Same category of hardness assumption — easy forward, infeasible in reverse — on a structure that happens to pack more security per bit.
    </p>
  `,
  },
};
