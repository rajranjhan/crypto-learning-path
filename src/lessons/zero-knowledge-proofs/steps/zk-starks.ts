...
export const zkStarks: Step = {
  id: "zk-starks",
  title: "zk-STARKs — Transparent Computation Proofs",
  prose:
  ...
  takeaway: "Choosing SNARK vs. STARK is a tradeoff between proof size, setup trust, and long-term cryptographic assumptions — not a strict upgrade either way.",
  figure: {
    body: `
    <div class="flow">
      <div class="node equal">
        <div class="node-title">zk-SNARK</div>
        <div class="node-sub left">small proofs; setup often needed</div>
      </div>
      <div class="node equal">
        <div class="node-title">zk-STARK</div>
        <div class="node-sub left">large proofs; transparent setup</div>
      </div>
    </div>
