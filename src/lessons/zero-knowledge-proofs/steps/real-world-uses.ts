...
export const realWorldUses: Step = {
  id: "real-world-uses",
  title: "ZKP Applications — Where Proofs Fit",
  prose:
  ...
  takeaway: "zk-rollups: batch thousands of blockchain transactions off-chain, then publish one succinct proof the main chain verifies instead of re-executing everything.",
};
