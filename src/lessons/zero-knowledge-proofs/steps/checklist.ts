...
export const checklist: Step = {
  ...
  callouts: [
    ...
    },
    {
      ...
      body: "Discrete-log-based ZK constructions inherit the same quantum exposure as the signatures covered in the Post-Quantum Cryptography lesson. Hash-based STARK-style constructions avoid Shor's discrete-log break, while still needing hash parameters with enough long-term margin.",
    },
  ],
};
