...
export const shorsAlgorithm: Step = {
  ...
  title: "Shor's Algorithm — RSA and ECC Risk",
  prose:
  ...
  takeaway: "No quantum computer today is anywhere near large enough to run this against real key sizes; credible timelines remain uncertain.",
  figure: {
    body: `
    <div class="flow">
      <div class="node attacker">
        <div class="node-title text-warning">RSA-2048 / ECC P-256</div>
        <div class="node-sub">breaks the underlying problem</div>
      </div>
    </div>
