...
export const whyQuantumMatters: Step = {
  ...
  prose:
    ...
    "<p>Those two algorithms land on completely different outcomes for the two families of cryptography this series has covered — one needs new public-key algorithms, while the other needs larger symmetric parameters with enough margin. The next two steps take them in turn.</p>",
  bullets: [
  ...
  diagram: `
    <div class="flow">
      <div class="node equal attacker">
        ...
        <div class="node-sub">threatens RSA, ECC, Diffie-Hellman, and related signatures</div>
      </div>
      <div class="node equal">
        <div class="node-title">Grover's algorithm</div>
        <div class="node-sub">quadratic speedup for generic search; symmetric sizes need margin</div>
      </div>
    </div>
