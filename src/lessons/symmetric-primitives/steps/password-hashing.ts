...
export const passwordHashing: Step = {
  id: "password-hashing",
  glossary: lessonTerms("salt"),
  title: "Password Hashing — Slow Verification",
  prose:
  ...
  takeaway: "Rule of thumb: SHA-2/HMAC for fingerprinting and authenticating high-entropy data; bcrypt/scrypt/Argon2 specifically for low-entropy human-chosen passwords.",
  figure: {
    body: `
    <div class="flow">
      ...
      <div class="node trusted">
        ...
        <div class="node-sub">slow and memory-hard</div>
      </div>
    </div>
