...
export const checklist: Step = {
  id: "checklist",
  title: "Blockchain Cryptography Checklist",
  prose:
  ...
  bullets: [
    ...
    "Digital signatures prove control of signing keys; ledger rules decide whether a transaction is authorized",
  ...
  takeaway: "The public notebook is readable unless the protocol explicitly adds privacy mechanisms.",
  callouts: [
    {
      requirementId: "Scope",
