...
export const blockchainCryptographyLesson: Lesson = {
  ...
  diagram: `
    ...
    <p class="diagram-note">
      The notebook is not private by default. Its safety comes from public,
      repeatable checks: anyone can recompute the fingerprints, signatures,
      receipt folders, and consensus evidence.
    </p>
  `,
  steps: [
    hashesChainBlocks,
