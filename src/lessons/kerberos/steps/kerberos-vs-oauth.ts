...
export const kerberosVsOauth: Step = {
  ...
  prose:
    "<p>This carnival's security has two halves: guest tickets at the front gate (OAuth, covered later in this series) and staff badges backstage (Kerberos, just covered). They chase the same underlying goal — let someone prove who they are and what they're allowed to do, over and over, without repeatedly exposing their one long-term secret — but they were built for different worlds, and it shows in almost every design choice.</p>" +
