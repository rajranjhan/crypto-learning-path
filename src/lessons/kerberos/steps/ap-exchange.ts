...
export const apExchange: Step = {
  id: "ap-exchange",
  title: "AP Exchange — Service Authentication",
  wireContext: {
    where: "The client has a service ticket and the corresponding session key.",
    now: "The client presents the ticket and a fresh authenticator to the service.",
    why: "The service needs evidence of current session-key possession as well as the ticket.",
  },
  prose:
  ...
  takeaway: "The AP exchange proves the client holds the service session key and can optionally prove the service does too.",
