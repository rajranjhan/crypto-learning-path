...
export const tgsExchange: Step = {
  id: "tgs-exchange",
  title: "TGS Exchange — Service Tickets",
  wireContext: {
    where: "The client has a TGT and its associated session key.",
    now: "The client asks the TGS for a ticket to a particular service.",
    why: "The target service needs a ticket protected with a key it can validate.",
  },
  prose:
  ...
  takeaway: "One shift code word, many door passes — repeat this exchange for every door, all day, without touching your password again.",
