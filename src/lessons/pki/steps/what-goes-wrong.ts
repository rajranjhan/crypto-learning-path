...
export const whatGoesWrong: Step = {
  ...
  bullets: [
    "The whole system's security rests on the root list being trustworthy and small — a fraudulent or stolen root seal makes every card underneath it forgeable",
