...
export const anatomyOfACertificate: Step = {
  ...
  prose:
    "<p>The bank's certificate is like a laminated ID card that says: \"this public key is valid for this name.\" The technical reality is narrower than the metaphor: ordinary domain-validated TLS certificates prove control of a DNS name such as example.com. They do not necessarily prove a company's legal identity, office address, or trustworthiness. Anyone could print a fake laminated card claiming to be anyone — a plastic card by itself proves nothing. What matters is what's printed on it, and, as the next step covers, whose stamp is on the back.</p>" +
