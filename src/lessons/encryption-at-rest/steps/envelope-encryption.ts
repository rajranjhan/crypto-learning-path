...
export const envelopeEncryption: Step = {
  ...
  bullets: [
    ...
    "Key hierarchy limits blast radius: KEK protects DEKs; DEKs protect data at a scoped layer",
