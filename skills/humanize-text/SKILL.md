---
name: humanize-text
description: Remove signs of AI-generated writing from text to make it sound natural and human-written. Detects and fixes patterns including inflated symbolism, promotional language, superficial -ing analyses, vague attributions, em dash overuse, rule of three, AI vocabulary words, passive voice, negative parallelisms, and filler phrases. Use this skill whenever the user asks to humanize, de-slop, or de-AI text; wants writing to sound less like ChatGPT/AI or more human; asks you to edit, polish, or review prose for AI tells; or pastes text and asks why it reads as AI-generated — even if they don't say the word "humanize".
metadata:
  version: "2.9.1"
---
